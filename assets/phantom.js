...
@license
  ...
  Access unminified JS in assets/phantom.js
...
if (console && console.log) {
  console.log('PHANTOM theme ('+theme.settings.themeVersion+') by PHANTOM Themes');
}
...
(function(){
  ...
  theme.announcementBar = (function() {
    ...
    function init() {
      ...
      var wrapper = bar.closest('.announcement-bar');
      if (wrapper && wrapper.dataset.speed) {
        args.autoPlay = parseInt(wrapper.dataset.speed, 10) || 5000;
      }
    ...
    function closeAnnouncement(){
      ...
      closeBtn.addEventListener('click', function(evt){
        evt.preventDefault();
        var bar = evt.currentTarget.closest('.announcement-bar');
        if (bar) {
