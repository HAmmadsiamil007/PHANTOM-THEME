...
class Settings_Registry extends Base_Registry {
	...
	private function section_branding(): array {
		return array(
			...
			'general_preloader_enable'     => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Preloader', 'optix-core' ),
			),
			'general_kc_img_base'          => array(
				...
				'label'    => __( 'Image Base Path', 'optix-core' ),
			),
			...
			'branding_apple_touch_icon'    => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Apple Touch Icon', 'optix-core' ),
			),
			'branding_site_tagline_enable' => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Site Tagline', 'optix-core' ),
			),
			'branding_site_tagline_text'   => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Custom Tagline', 'optix-core' ),
			),
			'branding_logo_retina'         => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Retina Logo', 'optix-core' ),
			),
			'branding_logo_dark'           => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Dark Mode Logo', 'optix-core' ),
			),
			'branding_logo_mobile'         => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Mobile Logo', 'optix-core' ),
			),
			'branding_preloader_style'     => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Preloader Style', 'optix-core' ),
			),
			'branding_browser_theme_color' => array(
				...
				'label'    => __( 'Browser Theme Color', 'optix-core' ),
			),
			'branding_logo_max_height'     => array(
				...
				'default'  => 60,
				'sanitize' => 'absint',
				'label'    => __( 'Logo Max Height', 'optix-core' ),
			),
			'branding_logo_padding'        => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Logo Padding', 'optix-core' ),
			),
			'branding_preloader_bg'        => array(
				...
				'default'  => '#ffffff',
				'sanitize' => 'sanitize_hex_color',
				'label'    => __( 'Preloader Background', 'optix-core' ),
			),
		);
	}
	...
	private function section_header(): array {
		return array(
			'header_logo'                   => array(
				...
				'default'  => '/logo.png',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Header Logo', 'optix-core' ),
			),
			'header_logo_width'             => array(
				...
				'default'  => 150,
				'sanitize' => 'absint',
				'label'    => __( 'Logo Width', 'optix-core' ),
			),
			'header_sticky'                 => array(
				'section'  => 'header',
				'type'     => 'bool',
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Sticky Header', 'optix-core' ),
			),
			'header_height'                 => array(
				'section'  => 'header',
				'type'     => 'int',
				'default'  => 80,
				'sanitize' => 'absint',
				'label'    => __( 'Header Height', 'optix-core' ),
			),
			'header_search_icon'            => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Search Icon', 'optix-core' ),
			),
			...
			'header_login_icon'             => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Login Icon', 'optix-core' ),
			),
			'header_cart_count'             => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Cart Count', 'optix-core' ),
			),
			'menu_font_size'                => array(
				...
				'default'  => 14,
				'sanitize' => 'absint',
				'label'    => __( 'Menu Font Size', 'optix-core' ),
			),
			'search_placeholder'            => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Search Placeholder', 'optix-core' ),
			),
			'header_layout'                 => array(
				'section'  => 'header',
				'type'     => 'select',
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Header Layout', 'optix-core' ),
			),
			'header_bg'                     => array(
				'section'      => 'header',
				'type'         => 'color',
				'default'      => '#ffffff',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Header Background', 'optix-core' ),
			...
			'header_text_color'             => array(
				...
				'default'      => '#222222',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Header Text Color', 'optix-core' ),
			...
			'header_padding_y'              => array(
				...
				'default'      => 0,
				'sanitize'     => 'absint',
				'label'        => __( 'Header Padding Top/Bottom', 'optix-core' ),
			...
			'header_padding_x'              => array(
				...
				'default'      => 0,
				'sanitize'     => 'absint',
				'label'        => __( 'Header Padding Left/Right', 'optix-core' ),
			...
			'header_border_color'           => array(
				...
				'default'      => '#e5e5e5',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Header Border Color', 'optix-core' ),
			...
			'header_border_width'           => array(
				...
				'default'      => 0,
				'sanitize'     => 'absint',
				'label'        => __( 'Header Border Width', 'optix-core' ),
			...
			'header_logo_alt'               => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Logo Alt Text', 'optix-core' ),
			),
			...
			'header_mobile_height'          => array(
				...
				'default'      => 60,
				'sanitize'     => 'absint',
				'label'        => __( 'Mobile Header Height', 'optix-core' ),
			...
			'header_banner_height'          => array(
				...
				'default'      => 600,
				'sanitize'     => 'absint',
				'label'        => __( 'Banner Height', 'optix-core' ),
			...
			'header_banner_overlay_color'   => array(
				...
				'default'  => '#000000',
				'sanitize' => 'sanitize_hex_color',
				'label'    => __( 'Banner Overlay Color', 'optix-core' ),
			),
			'header_banner_overlay_opacity' => array(
				...
				'default'  => 0.3,
				'sanitize' => 'floatval',
				'label'    => __( 'Banner Overlay Opacity', 'optix-core' ),
			),
			'header_transparent_logo'       => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Transparent Header Logo', 'optix-core' ),
			),
		);
	}
	...
	private function section_topbar(): array {
		return array(
			'topbar_enable'     => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Top Bar', 'optix-core' ),
			),
			...
			'topbar_bg'         => array(
				...
				'default'  => '#222222',
				'sanitize' => 'sanitize_hex_color',
				'label'    => __( 'Top Bar Background', 'optix-core' ),
			),
			'topbar_text'       => array(
				'section'  => 'topbar',
				'type'     => 'color',
				'default'  => '#ffffff',
				'sanitize' => 'sanitize_hex_color',
				'label'    => __( 'Top Bar Text Color', 'optix-core' ),
			),
			'topbar_languages'  => array(
				...
				'sanitize' => function ( $v ) {
						return $v; },
				'label'    => __( 'Language Switcher', 'optix-core' ),
			),
			'topbar_currencies' => array(
				...
				'sanitize' => function ( $v ) {
						return $v; },
				'label'    => __( 'Currency Switcher', 'optix-core' ),
			),
		);
	}
	...
	private function section_navigation(): array {
		return array(
			'footer_nav'                      => array(
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'Footer Navigation', 'optix-core' ),
			),
			'footer_support'                  => array(
				...
				'sanitize' => function ( $v ) {
						return $v; },
				'label'    => __( 'Support Links', 'optix-core' ),
			),
			'menu_layout'                     => array(
				'section'  => 'navigation',
				'type'     => 'select',
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Menu Layout', 'optix-core' ),
			),
			'mobile_menu_breakpoint'          => array(
				...
				'default'  => 'md',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Mobile Menu Breakpoint', 'optix-core' ),
			),
			'menu_animation'                  => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Menu Animation', 'optix-core' ),
			),
			'menu_indicator_icon'             => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Dropdown Indicator Icon', 'optix-core' ),
			),
			'nav_sticky_enable'               => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Sticky Nav', 'optix-core' ),
			),
			'nav_mega_menu_columns'           => array(
				...
				'default'  => 4,
				'sanitize' => 'absint',
				'label'    => __( 'Mega Menu Columns', 'optix-core' ),
			),
			'nav_mobile_menu_style'           => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Mobile Menu Style', 'optix-core' ),
			),
			'nav_dropdown_animation_duration' => array(
				...
				'default'  => '0.3s',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Dropdown Animation Duration', 'optix-core' ),
			),
			'nav_menu_height'                 => array(
				...
				'default'      => 60,
				'sanitize'     => 'absint',
				'label'        => __( 'Menu Height', 'optix-core' ),
			...
			'nav_submenu_width'               => array(
				...
				'default'      => 220,
				'sanitize'     => 'absint',
				'label'        => __( 'Submenu Width', 'optix-core' ),
			...
			'nav_menu_align'                  => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Menu Alignment', 'optix-core' ),
			),
			'nav_show_search'                 => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Search', 'optix-core' ),
			),
			'nav_show_cart'                   => array(
				'section'  => 'navigation',
				'type'     => 'bool',
			...
			'nav_submenu_animation'           => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Submenu Animation', 'optix-core' ),
			),
		);
	}
	...
	private function section_hero(): array {
		return array(
			'home_banner_enable'      => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Hero', 'optix-core' ),
			),
			'home_banner_heading'     => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Hero Heading', 'optix-core' ),
			),
			...
			'home_banner_description' => array(
				...
				'label'    => __( 'Hero Description', 'optix-core' ),
			),
			'home_banner_btn_text'    => array(
				...
				'default'  => 'Shop Now',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Button Text', 'optix-core' ),
			),
			'home_banner_btn_url'     => array(
				...
				'default'  => '/shop/',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Button URL', 'optix-core' ),
			),
			'home_banner_img1'        => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Hero Image', 'optix-core' ),
			),
			'home_banner_img2'        => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Hero Image 2', 'optix-core' ),
			),
			'hero_overlay_enable'     => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Overlay', 'optix-core' ),
			),
			'hero_overlay_color'      => array(
				...
				'default'      => '#000000',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Overlay Color', 'optix-core' ),
				'dependencies' => array(
					array(
	...
	private function section_collections(): array {
		return array(
			'home_categories_enable'  => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Categories', 'optix-core' ),
			),
			'home_categories_heading' => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Categories Heading', 'optix-core' ),
			),
			'home_categories_title'   => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Categories Title', 'optix-core' ),
			),
			'home_categories'         => array(
				...
				'sanitize' => function ( $v ) {
						return $v; },
				'label'    => __( 'Category Items', 'optix-core' ),
			),
			'collections_layout'      => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Collections Layout', 'optix-core' ),
			),
			'collections_columns'     => array(
				...
				'default'  => 3,
				'sanitize' => 'absint',
				'label'    => __( 'Collections Columns', 'optix-core' ),
			),
		);
	}
	...
	private function section_home_sections(): array {
		return array(
			'home_promotion_enable'          => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Promotion', 'optix-core' ),
			),
			'home_promotion_boxes'           => array(
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'Promotion Boxes', 'optix-core' ),
			),
			'home_products_enable'           => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Products', 'optix-core' ),
			),
			'home_products_heading'          => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Products Heading', 'optix-core' ),
			),
			'home_products_title'            => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Products Title', 'optix-core' ),
			),
			'home_products_count'            => array(
				...
				'default'  => 6,
				'sanitize' => 'absint',
				'label'    => __( 'Products Count', 'optix-core' ),
			),
			'home_products_btn_text'         => array(
				...
				'default'  => 'View All',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Products Button', 'optix-core' ),
			),
			'home_products_fallback_img'     => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Fallback Image', 'optix-core' ),
			),
			'home_products_price_multiplier' => array(
				...
				'default'  => 1.3,
				'sanitize' => 'floatval',
				'label'    => __( 'Price Multiplier', 'optix-core' ),
			),
			'home_cta_enable'                => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable CTA', 'optix-core' ),
			),
			...
			'home_cta_subtitle'              => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'CTA Subtitle', 'optix-core' ),
			),
			'home_cta_btn_text'              => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'CTA Button', 'optix-core' ),
			),
			...
			'home_top_selling_enable'        => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Top Selling', 'optix-core' ),
			),
			'home_top_selling_title'         => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Top Selling Title', 'optix-core' ),
			),
			'home_top_selling_count'         => array(
				...
				'default'  => 4,
				'sanitize' => 'absint',
				'label'    => __( 'Top Selling Count', 'optix-core' ),
			),
			'home_testimonials_enable'       => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Testimonials', 'optix-core' ),
			),
			'home_testimonials_heading'      => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Testimonials Heading', 'optix-core' ),
			),
			'home_testimonials_title'        => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Testimonials Title', 'optix-core' ),
			),
			'home_testimonials'              => array(
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'Testimonial Items', 'optix-core' ),
			),
			'home_instagram_enable'          => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Instagram', 'optix-core' ),
			),
			'home_instagram_heading'         => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Instagram Heading', 'optix-core' ),
			),
			'home_instagram_title'           => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Instagram Title', 'optix-core' ),
			),
			'home_instagram_images'          => array(
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'Instagram Images', 'optix-core' ),
			),
			'home_benefits_enable'           => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Benefits', 'optix-core' ),
			),
			'home_benefits'                  => array(
				'section'  => 'home_sections',
				'type'     => 'repeater',
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'Benefit Items', 'optix-core' ),
			),
			'home_brands_enable'             => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Brands', 'optix-core' ),
			),
			'home_brands_title'              => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Brands Title', 'optix-core' ),
			),
			'home_brands'                    => array(
				'section'  => 'home_sections',
				'type'     => 'repeater',
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'Brand Items', 'optix-core' ),
			),
			'home_hero_layout'               => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Hero Layout', 'optix-core' ),
			),
			'home_hero_height'               => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Hero Height', 'optix-core' ),
			),
			'home_hero_subheading'           => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Hero Subheading', 'optix-core' ),
			),
			...
			'home_hero_video'                => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Hero Video URL', 'optix-core' ),
			),
			'home_slider_enable'             => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Slider', 'optix-core' ),
			),
			'home_slider_items'              => array(
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'Slider Items', 'optix-core' ),
			),
			'home_features_enable'           => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Features Section', 'optix-core' ),
			),
			'home_features_heading'          => array(
				...
				'default'  => 'Features',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Features Heading', 'optix-core' ),
			),
			'home_features_title'            => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Features Title', 'optix-core' ),
			),
			'home_features_items'            => array(
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'Features Items', 'optix-core' ),
			),
			'home_blog_enable'               => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Blog Section', 'optix-core' ),
			),
			'home_blog_heading'              => array(
				...
				'default'  => 'Blog',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Blog Heading', 'optix-core' ),
			),
			'home_blog_title'                => array(
				...
				'default'  => 'Latest News',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Blog Title', 'optix-core' ),
			),
			'home_blog_count'                => array(
				...
				'default'  => 3,
				'sanitize' => 'absint',
				'label'    => __( 'Blog Post Count', 'optix-core' ),
			),
			'home_section_spacing'           => array(
				...
				'default'      => 80,
				'sanitize'     => 'absint',
				'label'        => __( 'Section Spacing', 'optix-core' ),
	...
	private function section_product_cards(): array {
		return array(
			'shop_columns'         => array(
				...
				'default'  => 3,
				'sanitize' => 'absint',
				'label'    => __( 'Shop Columns', 'optix-core' ),
			),
			'card_image_ratio'     => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Image Ratio', 'optix-core' ),
			),
			'card_hover_effect'    => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Hover Effect', 'optix-core' ),
			),
			'card_quick_view'      => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Quick View', 'optix-core' ),
			),
			'card_sale_badge'      => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Sale Badge', 'optix-core' ),
			),
			'card_sale_badge_text' => array(
				...
				'default'  => 'Sale!',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Sale Badge Text', 'optix-core' ),
			),
			'card_show_rating'     => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Rating', 'optix-core' ),
			),
			'card_show_cart_btn'   => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Cart Button', 'optix-core' ),
			),
		);
	}
	...
	private function section_shop_page(): array {
		return array(
			'shop_title'             => array(
				...
				'default'  => 'Shop',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Shop Page Title', 'optix-core' ),
			),
			'shop_products_per_page' => array(
				...
				'default'  => 12,
				'sanitize' => 'absint',
				'label'    => __( 'Products Per Page', 'optix-core' ),
			),
			'shop_enable_sidebar'    => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Sidebar', 'optix-core' ),
			),
			'shop_enable'            => array(
				'section'  => 'shop_page',
				'type'     => 'bool',
				'default'  => true,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Shop', 'optix-core' ),
			),
			'shop_layout'            => array(
				'section'  => 'shop_page',
				'type'     => 'select',
			...
			'shop_results_count'     => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Results Count', 'optix-core' ),
			),
			'shop_sorting'           => array(
				'section'  => 'shop_page',
				'type'     => 'bool',
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Sorting Dropdown', 'optix-core' ),
			),
			'shop_per_page'          => array(
				'section'  => 'shop_page',
				'type'     => 'number',
			...
			'show_shop_toolbar'      => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Shop Toolbar', 'optix-core' ),
			),
		);
	}
	...
	private function section_product_page(): array {
		return array(
			'product_related_title'                     => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Related Products Title', 'optix-core' ),
			),
			...
			'product_related_sale_tag'                  => array(
				...
				'default'  => 'Sale',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Sale Tag Text', 'optix-core' ),
			),
			'product_more_title'                        => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'More Products Title', 'optix-core' ),
			),
			'product_detail_title'                      => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Detail Section Title', 'optix-core' ),
			),
			'product_detail_name'                       => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Default Product Name', 'optix-core' ),
			),
			'product_detail_price'                      => array(
				...
				'default'  => '$38.00',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Default Price', 'optix-core' ),
			),
			'product_detail_original_price'             => array(
				...
				'default'  => '$89.00',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Original Price', 'optix-core' ),
			),
			'product_detail_rating'                     => array(
				...
				'default'  => '4.9/5',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Default Rating', 'optix-core' ),
			),
			'product_detail_desc'                       => array(
				...
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( 'Default Description', 'optix-core' ),
			),
			'product_detail_stock'                      => array(
				...
				'default'  => 'In stock',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Stock Status', 'optix-core' ),
			),
			...
			'product_detail_categories_label'           => array(
				...
				'default'  => 'Categories:',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Categories Label', 'optix-core' ),
			),
			'product_detail_categories_value'           => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Categories Value', 'optix-core' ),
			),
			'product_detail_tags_label'                 => array(
				...
				'default'  => 'Tags:',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Tags Label', 'optix-core' ),
			),
			'product_detail_tags_value'                 => array(
				...
				'default'  => 'Pjs, Pajamas',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Tags Value', 'optix-core' ),
			),
			'product_detail_color_label'                => array(
				...
				'default'  => 'Color:',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Color Label', 'optix-core' ),
			),
			'product_detail_add_to_cart'                => array(
				...
				'default'  => 'Add to Cart',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Add to Cart Text', 'optix-core' ),
			),
			'product_detail_wishlist'                   => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Wishlist Text', 'optix-core' ),
			),
			'product_detail_compare'                    => array(
				...
				'default'  => 'Compare',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Compare Text', 'optix-core' ),
			),
			'product_detail_safe_checkout'              => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Safe Checkout Text', 'optix-core' ),
			),
			'product_detail_tab_description'            => array(
				...
				'default'  => 'Description',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Tab: Description', 'optix-core' ),
			),
			'product_detail_tab_additional'             => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Tab: Additional', 'optix-core' ),
			),
			'product_detail_tab_reviews'                => array(
				...
				'default'  => 'Reviews',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Tab: Reviews', 'optix-core' ),
			),
			'product_detail_info_features_label'        => array(
				...
				'default'  => 'Features',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Features Label', 'optix-core' ),
			),
			'product_detail_info_features_value'        => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Features Value', 'optix-core' ),
			),
			'product_detail_info_materials_label'       => array(
				...
				'default'  => 'Materials',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Materials Label', 'optix-core' ),
			),
			'product_detail_info_materials_value'       => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Materials Value', 'optix-core' ),
			),
			'product_detail_info_types_label'           => array(
				...
				'default'  => 'Types',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Types Label', 'optix-core' ),
			),
			'product_detail_info_types_value'           => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Types Value', 'optix-core' ),
			),
			'product_detail_review_heading'             => array(
				...
				'default'  => 'Review',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Review Heading', 'optix-core' ),
			),
			'product_detail_review_title'               => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Review Title', 'optix-core' ),
			),
			'product_detail_review_btn'                 => array(
				...
				'default'  => 'Post Review',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Review Button', 'optix-core' ),
			),
			'product_detail_review_name_placeholder'    => array(
				...
				'default'  => 'Your Name',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Name Placeholder', 'optix-core' ),
			),
			'product_detail_review_email_placeholder'   => array(
				...
				'default'  => 'Your Email',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Email Placeholder', 'optix-core' ),
			),
			'product_detail_review_comment_placeholder' => array(
				...
				'default'  => 'Your Review',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Comment Placeholder', 'optix-core' ),
			),
			'product_detail_review_author'              => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Review Author', 'optix-core' ),
			),
			'product_detail_review_role'                => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Review Role', 'optix-core' ),
			),
			'product_layout'                            => array(
				...
				'default'  => 'standard',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Product Layout', 'optix-core' ),
	...
	private function section_woocommerce(): array {
		return array(
			'cart_title'                 => array(
				...
				'default'  => 'Cart',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Cart Title', 'optix-core' ),
			),
			'cart_heading'               => array(
				'section'  => 'woocommerce',
				'type'     => 'string',
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Cart Heading', 'optix-core' ),
			),
			'cart_continue_text'         => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Continue Shopping', 'optix-core' ),
			),
			'cart_summary_title'         => array(
				...
				'default'  => 'Summary',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Summary Title', 'optix-core' ),
			),
			...
			'cart_tax_description'       => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Tax Description', 'optix-core' ),
			),
			'cart_country_label'         => array(
				...
				'default'  => 'Country',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Country Label', 'optix-core' ),
			),
			'cart_country_placeholder'   => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Country Placeholder', 'optix-core' ),
			),
			'cart_subtotal_label'        => array(
				...
				'default'  => 'Sub Total',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Subtotal Label', 'optix-core' ),
			),
			'cart_total_label'           => array(
				...
				'default'  => 'Total',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Total Label', 'optix-core' ),
			),
			'cart_discount_label'        => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Discount Label', 'optix-core' ),
			),
			'cart_discount_placeholder'  => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Discount Placeholder', 'optix-core' ),
			),
			'cart_discount_btn'          => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Discount Button', 'optix-core' ),
			),
			'cart_checkout_text'         => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Checkout Button', 'optix-core' ),
			),
			'cart_coupon_enable'         => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Coupon', 'optix-core' ),
			),
			'cart_cross_sell_enable'     => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Cross-sell', 'optix-core' ),
			),
			'cart_state_label'           => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'State Label', 'optix-core' ),
			),
			'cart_state_placeholder'     => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'State Placeholder', 'optix-core' ),
			),
			...
			'checkout_title'             => array(
				...
				'default'  => 'Checkout',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Checkout Title', 'optix-core' ),
			),
			'checkout_step_shipping'     => array(
				...
				'default'  => 'Shipping',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Step: Shipping', 'optix-core' ),
			),
			'checkout_step_payment'      => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Step: Payment', 'optix-core' ),
			),
			'checkout_shipping_label'    => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Shipping Label', 'optix-core' ),
			),
			'checkout_email_label'       => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Email Label', 'optix-core' ),
			),
			'checkout_next_btn'          => array(
				...
				'default'  => 'Next',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Next Button', 'optix-core' ),
			),
			'checkout_terms_text'        => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Terms Text', 'optix-core' ),
			),
			'checkout_terms_link_text'   => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Terms Link Text', 'optix-core' ),
			),
			'shop_catalog_mode'          => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Catalog Mode', 'optix-core' ),
			),
			'shop_cart_icon_style'       => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Cart Icon Style', 'optix-core' ),
			),
			'shop_wishlist_enable'       => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Wishlist', 'optix-core' ),
			),
			'shop_product_image_zoom'    => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Image Zoom', 'optix-core' ),
			),
			'shop_variant_swatches'      => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Variant Swatches', 'optix-core' ),
			),
			'shop_stock_display'         => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Stock Display', 'optix-core' ),
			),
			'shop_review_enable'         => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Reviews', 'optix-core' ),
			),
			'shop_ajax_add_to_cart'      => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'AJAX Add to Cart', 'optix-core' ),
			),
			'shop_minicart_enable'       => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Mini Cart', 'optix-core' ),
			),
			'shop_checkout_style'        => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Checkout Style', 'optix-core' ),
			),
			'shop_order_tracking_enable' => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Order Tracking', 'optix-core' ),
			),
			'shop_sale_flash_style'      => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Sale Flash Style', 'optix-core' ),
			),
			'shop_show_stock_badge'      => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Stock Badge', 'optix-core' ),
			),
		);
	}
	...
	private function section_blog(): array {
		return array(
			'blog_enable'                           => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Blog', 'optix-core' ),
			),
			'blog_title'                            => array(
				'section'  => 'blog',
				'type'     => 'string',
			...
			'blog_posts_per_page'                   => array(
				...
				'default'  => 6,
				'sanitize' => 'absint',
				'label'    => __( 'Posts Per Page', 'optix-core' ),
			),
			'blog_tabs'                             => array(
				'section'  => 'blog',
				'type'     => 'array',
			...
			'blog_layout'                           => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Blog Layout', 'optix-core' ),
			),
			'blog_show_sidebar'                     => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Sidebar', 'optix-core' ),
			),
			'blog_show_featured_image'              => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Featured Image', 'optix-core' ),
			),
			'blog_show_author'                      => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Author', 'optix-core' ),
			),
			'single_blog_show_related'              => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Related Posts', 'optix-core' ),
			),
			'single_blog_related_title'             => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Related Posts Title', 'optix-core' ),
			),
			'blog_excerpt_length'                   => array(
				...
				'default'  => 55,
				'sanitize' => 'absint',
				'label'    => __( 'Excerpt Length', 'optix-core' ),
			),
			'blog_read_more_text'                   => array(
				...
				'default'  => 'Read More',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Read More Text', 'optix-core' ),
			),
			...
			'blog_show_categories'                  => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Categories', 'optix-core' ),
			),
			...
			'blog_enable_comments'                  => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Comments', 'optix-core' ),
			),
			'blog_show_author_box'                  => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Author Box', 'optix-core' ),
			),
			'blog_show_related_count'               => array(
				...
				'default'  => 3,
				'sanitize' => 'absint',
				'label'    => __( 'Related Posts Count', 'optix-core' ),
			),
			'blog_sidebar_position'                 => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Sidebar Position', 'optix-core' ),
			),
			'blog_sticky_sidebar'                   => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Sticky Sidebar', 'optix-core' ),
			),
			'single_blog_author_image'              => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Author Image', 'optix-core' ),
			),
			'single_blog_author_name'               => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Author Name', 'optix-core' ),
			),
			'single_blog_author_role'               => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Author Role', 'optix-core' ),
			),
			'single_blog_author_bio'                => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( 'Author Bio', 'optix-core' ),
			),
			'single_blog_quote_image'               => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Quote Image', 'optix-core' ),
			),
			'single_blog_quote_text'                => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( 'Quote Text', 'optix-core' ),
			),
			'single_blog_prev_text'                 => array(
				...
				'default'  => 'Prev',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Previous Text', 'optix-core' ),
			),
			...
			'single_blog_tags_heading'              => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Tags Heading', 'optix-core' ),
			),
			'single_blog_social_heading'            => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Social Heading', 'optix-core' ),
			),
			'single_blog_reply_text'                => array(
				...
				'default'  => 'Reply',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Reply Text', 'optix-core' ),
			),
			'single_blog_comment_heading'           => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Comment Heading', 'optix-core' ),
			),
			...
			'single_blog_comment_btn'               => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Comment Button', 'optix-core' ),
			),
			'single_blog_search_heading'            => array(
				...
				'default'  => 'Search News',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Search Heading', 'optix-core' ),
			),
			...
			'single_blog_follow_heading'            => array(
				...
				'default'  => 'Follow Us',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Follow Heading', 'optix-core' ),
			),
			'single_blog_feeds_heading'             => array(
				...
				'default'  => 'Feeds',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Feeds Heading', 'optix-core' ),
			),
			'single_blog_tags_sidebar_heading'      => array(
				...
				'default'  => 'Tags',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Tags Sidebar Heading', 'optix-core' ),
			),
			'blog_excerpt_more'                     => array(
				...
				'default'  => '...',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Excerpt More Text', 'optix-core' ),
			),
			'blog_single_layout'                    => array(
				...
				'default'  => 'full',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Single Post Layout', 'optix-core' ),
			...
			'blog_archive_layout'                   => array(
				...
				'default'  => 'grid',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Archive Layout', 'optix-core' ),
			...
			'blog_wpm'                              => array(
				...
				'default'  => 200,
				'sanitize' => 'absint',
				'label'    => __( 'Words Per Minute', 'optix-core' ),
				'desc'     => __( 'Used for estimated reading time calculation.', 'optix-core' ),
			),
		);
	}
	...
	private function section_footer(): array {
		return array(
			'footer_logo'                 => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Footer Logo', 'optix-core' ),
			),
			'footer_about_text'           => array(
				...
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( 'About Text', 'optix-core' ),
			),
			'footer_copyright'            => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Copyright Text', 'optix-core' ),
			),
			'footer_payment_cards'        => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Payment Cards Image', 'optix-core' ),
			),
			'footer_phone'                => array(
				'section'  => 'footer',
				'type'     => 'string',
			...
			'footer_link'                 => array(
				...
				'default'      => '#cccccc',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Link Color', 'optix-core' ),
			...
			'footer_social_links'         => array(
				...
				'sanitize' => function ( $v ) {
						return $v; },
				'label'    => __( 'Social Links', 'optix-core' ),
			),
			'footer_social'               => array(
				'section'  => 'footer',
				'type'     => 'repeater',
				...
				'sanitize' => function ( $v ) {
						return $v; },
				'label'    => __( 'Social (Alt)', 'optix-core' ),
			),
			'newsletter_heading'          => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Newsletter Heading', 'optix-core' ),
			),
			'newsletter_placeholder'      => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Newsletter Placeholder', 'optix-core' ),
			),
			'newsletter_btn_text'         => array(
				...
				'default'  => 'Subscribe',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Newsletter Button', 'optix-core' ),
			),
			'newsletter_action_url'       => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Newsletter Action URL', 'optix-core' ),
			),
			'footer_enable'               => array(
				'section'  => 'footer',
				'type'     => 'bool',
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Footer', 'optix-core' ),
			),
			'footer_columns'              => array(
				...
				'default'  => 4,
				'sanitize' => 'absint',
				'label'    => __( 'Footer Columns', 'optix-core' ),
			),
			'footer_width'                => array(
				'section'  => 'footer',
				'type'     => 'select',
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Footer Width', 'optix-core' ),
			),
			'footer_border_enable'        => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Footer Border', 'optix-core' ),
			),
			'footer_border_color'         => array(
				...
				'default'      => '#333333',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Footer Border Color', 'optix-core' ),
			...
			'footer_bg_color'             => array(
				...
				'default'      => '#222222',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Footer Background', 'optix-core' ),
			...
			'footer_scroll_to_top_enable' => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Scroll to Top', 'optix-core' ),
			),
			'footer_scroll_to_top_color'  => array(
				...
				'default'  => '#ffffff',
				'sanitize' => 'sanitize_hex_color',
				'label'    => __( 'Scroll to Top Icon Color', 'optix-core' ),
			),
			'footer_scroll_to_top_bg'     => array(
				...
				'default'  => '#705b53',
				'sanitize' => 'sanitize_hex_color',
				'label'    => __( 'Scroll to Top Background', 'optix-core' ),
			),
			'footer_social_enable'        => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Social Links', 'optix-core' ),
			),
			'footer_newsletter_enable'    => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Newsletter', 'optix-core' ),
			),
			'footer_bottom_bar_enable'    => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Bottom Bar', 'optix-core' ),
			),
			'footer_layout'               => array(
				'section'  => 'footer',
				'type'     => 'select',
				'default'  => '3-col',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Footer Layout', 'optix-core' ),
	...
	private function section_typography(): array {
		return array(
			'typography_heading_font'   => array(
				...
				'default'      => 'Archivo',
				'sanitize'     => 'sanitize_text_field',
				'label'        => __( 'Heading Font', 'optix-core' ),
			...
			'typography_base_size'      => array(
				...
				'default'      => 16,
				'sanitize'     => 'absint',
				'label'        => __( 'Base Font Size', 'optix-core' ),
			...
			'typography_heading_weight' => array(
				...
				'default'      => '700',
				'sanitize'     => 'sanitize_text_field',
				'label'        => __( 'Heading Weight', 'optix-core' ),
			...
			'typography_body_weight'    => array(
				...
				'default'      => '400',
				'sanitize'     => 'sanitize_text_field',
				'label'        => __( 'Body Weight', 'optix-core' ),
			...
			'typography_line_height'    => array(
				...
				'default'      => 1.6,
				'sanitize'     => 'floatval',
				'label'        => __( 'Line Height', 'optix-core' ),
			...
			'typography_letter_spacing' => array(
				...
				'default'      => 0,
				'sanitize'     => 'absint',
				'label'        => __( 'Letter Spacing', 'optix-core' ),
			...
			'typography_heading_case'   => array(
				...
				'sanitize'     => 'sanitize_text_field',
				'label'        => __( 'Heading Text Case', 'optix-core' ),
	...
	private function section_colors(): array {
		return array(
			...
			'color_link_hover' => array(
				...
				'default'      => '#c19a6b',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Link Hover', 'optix-core' ),
			...
			'color_border'     => array(
				...
				'default'      => '#e5e5e5',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Border Color', 'optix-core' ),
			...
			'color_sale'       => array(
				...
				'default'      => '#e74c3c',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Sale Color', 'optix-core' ),
	...
	private function section_buttons(): array {
		return array(
			'button_bg'         => array(
				...
				'default'      => '#705b53',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Button Background', 'optix-core' ),
			...
			'button_bg_hover'   => array(
				...
				'default'      => '#c19a6b',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Button Hover BG', 'optix-core' ),
			...
			'button_text_hover' => array(
				...
				'default'      => '#ffffff',
				'sanitize'     => 'sanitize_hex_color',
				'label'        => __( 'Button Hover Text', 'optix-core' ),
			...
			'button_radius'     => array(
				...
				'default'      => 4,
				'sanitize'     => 'absint',
				'label'        => __( 'Button Radius', 'optix-core' ),
			...
			'button_padding_y'  => array(
				...
				'default'      => 12,
				'sanitize'     => 'absint',
				'label'        => __( 'Button Padding Y', 'optix-core' ),
			...
			'button_padding_x'  => array(
				...
				'default'      => 24,
				'sanitize'     => 'absint',
				'label'        => __( 'Button Padding X', 'optix-core' ),
			...
			'button_font_size'  => array(
				...
				'default'      => 14,
				'sanitize'     => 'absint',
				'label'        => __( 'Button Font Size', 'optix-core' ),
	...
	private function section_forms(): array {
		return array(
			'checkout_fname_label'            => array(
				...
				'default'  => 'First Name',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'First Name Label', 'optix-core' ),
			),
			'checkout_lname_label'            => array(
				...
				'default'  => 'Last Name',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Last Name Label', 'optix-core' ),
			),
			'checkout_account_note'           => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Account Note', 'optix-core' ),
			),
			'checkout_street_line1_label'     => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Street Line 1', 'optix-core' ),
			),
			...
			'checkout_city_label'             => array(
				...
				'default'  => 'City',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'City Label', 'optix-core' ),
			),
			'checkout_city_placeholder'       => array(
				...
				'default'  => 'Select City',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'City Placeholder', 'optix-core' ),
			),
			...
			'checkout_items_label'            => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Items Label', 'optix-core' ),
			),
			...
			'checkout_item_price'             => array(
				...
				'default'  => '$38.00',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Item Price', 'optix-core' ),
			),
			'checkout_payment_label'          => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Payment Label', 'optix-core' ),
			),
			'checkout_credit_card_label'      => array(
				...
				'default'  => 'Credit card',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Credit Card Label', 'optix-core' ),
			),
			'checkout_card_number_label'      => array(
				...
				'default'  => 'Card number',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Card Number Label', 'optix-core' ),
			),
			'checkout_expiration_label'       => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Expiration Label', 'optix-core' ),
			),
			'checkout_month_placeholder'      => array(
				...
				'default'  => 'Month',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Month Placeholder', 'optix-core' ),
			),
			'checkout_year_placeholder'       => array(
				...
				'default'  => 'Year',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Year Placeholder', 'optix-core' ),
			),
			'checkout_security_label'         => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Security Label', 'optix-core' ),
			),
			...
			'checkout_shipping_methods_label' => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Shipping Methods Label', 'optix-core' ),
			),
			'checkout_shipping_free_price'    => array(
				...
				'default'  => '$0.00',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Free Shipping Price', 'optix-core' ),
			),
			'checkout_shipping_free_label'    => array(
				...
				'default'  => 'Free',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Free Shipping Label', 'optix-core' ),
			),
			'checkout_shipping_free_name'     => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Free Shipping Name', 'optix-core' ),
			),
			'checkout_shipping_flat_price'    => array(
				...
				'default'  => '$5.00',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Flat Rate Price', 'optix-core' ),
			),
			'checkout_shipping_flat_label'    => array(
				...
				'default'  => 'Fixed',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Flat Rate Label', 'optix-core' ),
			),
			'checkout_shipping_flat_name'     => array(
				...
				'default'  => 'Flat Rate',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Flat Rate Name', 'optix-core' ),
			),
			'checkout_company_label'          => array(
				...
				'default'  => 'Company',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Company Label', 'optix-core' ),
			),
			'checkout_street_label'           => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Street Label', 'optix-core' ),
			),
			'checkout_phone_label'            => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Phone Label', 'optix-core' ),
			),
			'form_input_border_radius'        => array(
				...
				'default'      => 4,
				'sanitize'     => 'absint',
				'label'        => __( 'Input Border Radius', 'optix-core' ),
			...
			'form_input_height'               => array(
				...
				'default'      => 48,
				'sanitize'     => 'absint',
				'label'        => __( 'Input Height', 'optix-core' ),
	...
	private function section_spacing(): array {
		return array(
			'section_padding_y'     => array(
				...
				'default'      => 80,
				'sanitize'     => 'absint',
				'label'        => __( 'Section Padding Y', 'optix-core' ),
			...
			'section_padding_x'     => array(
				...
				'default'      => 0,
				'sanitize'     => 'absint',
				'label'        => __( 'Section Padding X', 'optix-core' ),
			...
			'container_gutter'      => array(
				...
				'default'      => 30,
				'sanitize'     => 'absint',
				'label'        => __( 'Container Gutter', 'optix-core' ),
			...
			'content_gap'           => array(
				...
				'default'      => 30,
				'sanitize'     => 'absint',
				'label'        => __( 'Content Gap', 'optix-core' ),
			...
			'element_margin_bottom' => array(
				...
				'default'      => 20,
				'sanitize'     => 'absint',
				'label'        => __( 'Element Margin Bottom', 'optix-core' ),
			...
			'widget_spacing'        => array(
				...
				'default'      => 40,
				'sanitize'     => 'absint',
				'label'        => __( 'Widget Spacing', 'optix-core' ),
	...
	private function section_layout(): array {
		return array(
			'container_width'           => array(
				...
				'default'      => 1200,
				'sanitize'     => 'absint',
				'label'        => __( 'Container Width', 'optix-core' ),
			...
			'layout_boxed_mode'         => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Boxed Mode', 'optix-core' ),
			),
			'layout_boxed_width'        => array(
				...
				'default'      => 1440,
				'sanitize'     => 'absint',
				'label'        => __( 'Boxed Width', 'optix-core' ),
			...
			'content_width'             => array(
				...
				'default'      => 800,
				'sanitize'     => 'absint',
				'label'        => __( 'Content Width', 'optix-core' ),
			...
			'sidebar_width'             => array(
				...
				'default'      => 380,
				'sanitize'     => 'absint',
				'label'        => __( 'Sidebar Width', 'optix-core' ),
			...
			'four_column_title'         => array(
				...
				'default'  => 'Four Column',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Four Column Title', 'optix-core' ),
			),
			'three_column_title'        => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Three Column Title', 'optix-core' ),
			),
			'three_colum_sidbar_title'  => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Three Column Sidebar', 'optix-core' ),
			),
			'two_column_title'          => array(
				...
				'default'  => 'Two Column',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Two Column Title', 'optix-core' ),
			),
			'six_colum_full_wide_title' => array(
				...
				'default'  => 'Six Column',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Six Column', 'optix-core' ),
			),
			'one_column_title'          => array(
				...
				'default'  => 'One Column',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'One Column Title', 'optix-core' ),
			),
		);
	}
	...
	private function section_responsive(): array {
		return array(
			'breakpoint_xl' => array(
				...
				'default'      => 1200,
				'sanitize'     => 'absint',
				'label'        => __( 'XL Breakpoint', 'optix-core' ),
			...
			'breakpoint_lg' => array(
				...
				'default'      => 992,
				'sanitize'     => 'absint',
				'label'        => __( 'LG Breakpoint', 'optix-core' ),
			...
			'breakpoint_md' => array(
				...
				'default'      => 768,
				'sanitize'     => 'absint',
				'label'        => __( 'MD Breakpoint', 'optix-core' ),
			...
			'breakpoint_sm' => array(
				...
				'default'      => 576,
				'sanitize'     => 'absint',
				'label'        => __( 'SM Breakpoint', 'optix-core' ),
	...
	private function section_animations(): array {
		return array(
			...
			'animations_duration' => array(
				...
				'default'  => '2s',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Animation Duration', 'optix-core' ),
			),
			'animations_delay'    => array(
				...
				'default'  => '0.05s',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Animation Delay', 'optix-core' ),
			),
			'animations_easing'   => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Animation Easing', 'optix-core' ),
			),
			'animations_scroll'   => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Scroll Animations', 'optix-core' ),
			),
		);
	}
	...
	private function section_effects_3d(): array {
		return array(
			'effect_3d_enable'      => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Enable 3D Effects', 'optix-core' ),
			),
			'effect_3d_perspective' => array(
				...
				'default'  => 1000,
				'sanitize' => 'absint',
				'label'    => __( '3D Perspective', 'optix-core' ),
			),
			'effect_3d_rotate_x'    => array(
				...
				'default'  => 5,
				'sanitize' => 'absint',
				'label'    => __( '3D Rotate X', 'optix-core' ),
			),
			'effect_3d_rotate_y'    => array(
				...
				'default'  => 5,
				'sanitize' => 'absint',
				'label'    => __( '3D Rotate Y', 'optix-core' ),
			),
		);
	}
	...
	private function section_search(): array {
		return array(
			'search_ajax_enable'  => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Ajax Search', 'optix-core' ),
			),
			'search_live_results' => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Live Results', 'optix-core' ),
			),
			'search_suggestions'  => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Suggestions', 'optix-core' ),
			),
			'search_max_results'    => array(
				...
				'default'  => 5,
				'sanitize' => 'absint',
				'label'    => __( 'Max Results', 'optix-core' ),
			),
			'search_post_types'     => array(
				'section'  => 'search',
				'type'     => 'multiselect',
				'default'  => array( 'post', 'product' ),
				'label'    => __( 'Search Post Types', 'optix-core' ),
			),
			'search_per_page'       => array(
				...
				'default'  => 10,
				'sanitize' => 'absint',
				'label'    => __( 'Results Per Page', 'optix-core' ),
			),
			'search_no_results'     => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'No Results Message', 'optix-core' ),
			),
		);
	}
	...
	private function section_performance(): array {
		return array(
			'performance_lazy_load'            => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Lazy Load Images', 'optix-core' ),
			),
			'performance_minify_css'           => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Minify CSS', 'optix-core' ),
			),
			...
			'performance_defer_js'             => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Defer Non-critical JS', 'optix-core' ),
			),
			'performance_preload_fonts'        => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Preload Fonts', 'optix-core' ),
			),
			'performance_combine_css'          => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Combine CSS Files', 'optix-core' ),
			),
			'performance_dns_prefetch'         => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Enable DNS Prefetch', 'optix-core' ),
			),
			'performance_dns_prefetch_domains' => array(
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'DNS Prefetch Domains', 'optix-core' ),
			),
			'performance_preconnect_domains'   => array(
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'Preconnect Domains', 'optix-core' ),
			),
			'performance_preload_hero'         => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Preload Hero Image', 'optix-core' ),
			),
			'performance_font_display'         => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Font Display Strategy', 'optix-core' ),
			),
			'performance_remove_wp_emoji'      => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Remove WP Emoji', 'optix-core' ),
			),
			'performance_remove_wp_block_css'  => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Remove Block Library CSS', 'optix-core' ),
			),
		);
	}
	...
	private function section_seo(): array {
		return array(
			'seo_breadcrumbs_enable' => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Breadcrumbs', 'optix-core' ),
			),
			'seo_schema_enable'      => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Schema Markup', 'optix-core' ),
			),
			'seo_og_enable'          => array(
				'section'  => 'seo',
				'type'     => 'bool',
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Open Graph', 'optix-core' ),
			),
			'seo_og_default_image'   => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Default OG Image', 'optix-core' ),
			),
			'seo_meta_description'   => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( 'Meta Description', 'optix-core' ),
				'desc'     => __( 'Used by Head_Manager for <meta name="description"> output.', 'optix-core' ),
			),
			'seo_meta_keywords'      => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Meta Keywords', 'optix-core' ),
				'desc'     => __( 'Comma-separated keywords.', 'optix-core' ),
			),
			'seo_og_title'           => array(
				'section'  => 'seo',
				'type'     => 'string',
				'default'  => '',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'OG Title', 'optix-core' ),
				'desc'     => __( 'Open Graph title (falls back to page title if empty).', 'optix-core' ),
			),
			'seo_og_description'     => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( 'OG Description', 'optix-core' ),
				'desc'     => __( 'Open Graph description.', 'optix-core' ),
			),
			'seo_og_image'           => array(
				'section'  => 'seo',
				'type'     => 'image',
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'OG Image', 'optix-core' ),
				'desc'     => __( 'Per-page OG image override.', 'optix-core' ),
			),
		);
	}
	...
	private function section_accessibility(): array {
		return array(
			'a11y_keyboard_nav'  => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Keyboard Nav', 'optix-core' ),
			),
			'a11y_skip_links'    => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Skip Links', 'optix-core' ),
			),
			'a11y_focus_outline' => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Show Focus Outline', 'optix-core' ),
			),
			'a11y_contrast_mode' => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'High Contrast Mode', 'optix-core' ),
			),
			'a11y_font_size'     => array(
				...
				'default'  => 100,
				'sanitize' => 'absint',
				'label'    => __( 'Font Size (%)', 'optix-core' ),
				'desc'     => __( 'Base font size percentage for accessibility scaling.', 'optix-core' ),
			),
			'a11y_high_contrast' => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'High Contrast Mode Override', 'optix-core' ),
				'desc'     => __( 'Engine-level high contrast flag for body class.', 'optix-core' ),
			),
		);
	}
	...
	private function section_integrations(): array {
		return array(
			'social_facebook'     => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Facebook URL', 'optix-core' ),
			),
			'social_instagram'    => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Instagram URL', 'optix-core' ),
			),
			'social_youtube'      => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'YouTube URL', 'optix-core' ),
			),
			'social_twitter'      => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Twitter URL', 'optix-core' ),
			),
			'social_pinterest'    => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Pinterest URL', 'optix-core' ),
			),
			'social_tiktok'       => array(
				'section'  => 'integrations',
				'type'     => 'string',
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'TikTok URL', 'optix-core' ),
			),
			'cookie_enable'       => array(
				'section'  => 'integrations',
				'type'     => 'bool',
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Cookie Notice', 'optix-core' ),
			),
			'cookie_message'      => array(
				...
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( 'Cookie Message', 'optix-core' ),
			),
			'cookie_accept_text'  => array(
				...
				'default'  => 'Accept',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Accept Text', 'optix-core' ),
			),
			'cookie_decline_text' => array(
				...
				'default'  => 'Decline',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Decline Text', 'optix-core' ),
			),
			'cookie_policy_link'  => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Policy Link', 'optix-core' ),
			),
			'cookie_title'        => array(
				'section'  => 'integrations',
				'type'     => 'string',
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Cookie Title', 'optix-core' ),
			),
			'cookie_content'      => array(
				...
				'default'  => '',
				'sanitize' => 'wp_kses_post',
				'label'    => __( 'Cookie Content', 'optix-core' ),
			),
			'google_analytics_id' => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Google Analytics ID', 'optix-core' ),
				'desc'     => __( 'Format: UA-XXXXX-Y or G-XXXXXXXXXX.', 'optix-core' ),
			),
			'google_tag_manager'  => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Google Tag Manager ID', 'optix-core' ),
				'desc'     => __( 'Format: GTM-XXXXXXX.', 'optix-core' ),
			),
			'facebook_pixel'      => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Facebook Pixel ID', 'optix-core' ),
				'desc'     => __( 'Format: 000000000000000.', 'optix-core' ),
			),
		);
	}
	...
	private function section_custom_code(): array {
		return array(
			'custom_css'            => array(
				...
				'label'    => __( 'Custom CSS', 'optix-core' ),
				'autoload' => false,
			),
			'custom_js'             => array(
				'section'  => 'custom_code',
			...
			'custom_head_scripts'   => array(
				...
				'label'    => __( 'Head Scripts', 'optix-core' ),
				'autoload' => false,
			),
			'custom_footer_scripts' => array(
				...
				'default'  => '',
				'sanitize' => $this->sanitize_code_passthrough(),
				'label'    => __( 'Footer Scripts', 'optix-core' ),
				'autoload' => false,
			),
		);
	}
	...
	private function section_import_export(): array {
		return array(
			'import_export_export_data'   => array(
				...
				'default'  => '',
				'sanitize' => $this->sanitize_code_passthrough(),
				'label'    => __( 'Export Data', 'optix-core' ),
				'autoload' => false,
			),
			'import_export_import_data'   => array(
				...
				'default'  => '',
				'sanitize' => $this->sanitize_code_passthrough(),
				'label'    => __( 'Import Data', 'optix-core' ),
				'autoload' => false,
			),
			'import_export_reset_confirm' => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Confirm Reset', 'optix-core' ),
			),
		);
	}
	...
	private function section_about_page(): array {
		return array(
			'about_about_enable'      => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable About Section', 'optix-core' ),
			),
			'about_about_heading'     => array(
				...
				'default'  => 'About Us',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'About Heading', 'optix-core' ),
			),
			'about_about_title'       => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'About Title', 'optix-core' ),
			),
			'about_about_text_1'      => array(
				...
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( 'About Text 1', 'optix-core' ),
			),
			'about_about_text_2'      => array(
				...
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( 'About Text 2', 'optix-core' ),
			),
			'about_about_image'       => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'About Image', 'optix-core' ),
			),
			'about_about_btn_text'    => array(
				...
				'default'  => 'Read More',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'About Button', 'optix-core' ),
			),
			'about_about_btn_url'     => array(
				...
				'default'  => '/shop/',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'About Button URL', 'optix-core' ),
			),
			'about_mission_enable'    => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Mission', 'optix-core' ),
			),
			'about_mission_heading'   => array(
				...
				'default'  => 'Our Mission',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Mission Heading', 'optix-core' ),
			),
			'about_mission_title'     => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Mission Title', 'optix-core' ),
			),
			'about_mission_text_1'    => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( 'Mission Text 1', 'optix-core' ),
			),
			'about_mission_text_2'    => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( 'Mission Text 2', 'optix-core' ),
			),
			'about_team_enable'       => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Team', 'optix-core' ),
			),
			'about_team_heading'      => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Team Heading', 'optix-core' ),
			),
			'about_team_title'        => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Team Title', 'optix-core' ),
			),
			'about_team_members'      => array(
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'Team Members', 'optix-core' ),
			),
	...
	private function section_contact_page(): array {
		return array(
			'contact_info_heading'    => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Info Heading', 'optix-core' ),
			),
			'contact_info_title'      => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Info Title', 'optix-core' ),
			),
			'contact_location_icon'   => array(
				...
				'default'  => '/loc-img.png',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Location Icon', 'optix-core' ),
			),
			'contact_location_text'   => array(
				...
				'sanitize' => 'wp_kses_post',
				'label'    => __( 'Location Text', 'optix-core' ),
			),
			'contact_location_title'  => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Location Title', 'optix-core' ),
			),
			'contact_phone_icon'      => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Phone Icon', 'optix-core' ),
			),
			'contact_phone_numbers'   => array(
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'Phone Numbers', 'optix-core' ),
			),
			'contact_phone_title'     => array(
				...
				'default'  => 'Phone Number',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Phone Title', 'optix-core' ),
			),
			'contact_email_icon'      => array(
				...
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Email Icon', 'optix-core' ),
			),
			'contact_email_addresses' => array(
				...
				'sanitize' => function ( $v ) {
					return $v; },
				'label'    => __( 'Email Addresses', 'optix-core' ),
			),
			'contact_email_title'     => array(
				...
				'default'  => 'Email Us:',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Email Title', 'optix-core' ),
			),
			'contact_form_heading'    => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Form Heading', 'optix-core' ),
			),
			'contact_form_title'      => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Form Title', 'optix-core' ),
			),
			'contact_form_btn_text'   => array(
				...
				'default'  => 'Send Now',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Form Button', 'optix-core' ),
			),
	...
	private function section_faq_page(): array {
		return array(
			'faq_enable'           => array(
				...
				'default'  => 1,
				'sanitize' => 'absint',
				'label'    => __( 'Enable FAQ', 'optix-core' ),
			),
			'faq_heading'          => array(
				'section'  => 'faq_page',
				'type'     => 'string',
				'default'  => 'FAQs',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'FAQ Heading', 'optix-core' ),
			),
			'faq_title'            => array(
				'section'  => 'faq_page',
				'type'     => 'string',
	...
	private function section_coming_soon(): array {
		return array(
			...
			'coming_soon_date'        => array(
				...
				'default'  => '',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Launch Date', 'optix-core' ),
			),
			'maintenance_mode_enable' => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Maintenance', 'optix-core' ),
			),
		);
	}
	...
	private function section_error_404(): array {
		return array(
			...
			'404_description' => array(
				...
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( '404 Description', 'optix-core' ),
			),
			'404_btn_text'    => array(
				'section'  => 'error_404',
				'type'     => 'string',
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( '404 Button', 'optix-core' ),
			),
		);
	}
	...
	private function section_login_page(): array {
		return array(
			'login_title'              => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Login Title', 'optix-core' ),
			),
			'login_btn_text'           => array(
				...
				'default'  => 'Login',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Login Button', 'optix-core' ),
			),
			...
			'login_password_label'     => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Password Label', 'optix-core' ),
			),
			'login_remember_label'     => array(
				...
				'default'  => 'Remember me',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Remember Label', 'optix-core' ),
			),
			'login_lost_password_text' => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Lost Password Text', 'optix-core' ),
			),
			'login_lost_password_url'  => array(
				...
				'default'  => '/contact/',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Lost Password URL', 'optix-core' ),
			),
			'login_join_link'          => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Join Link Text', 'optix-core' ),
			),
			'login_logo'               => array(
				'section'  => 'login_page',
				'type'     => 'string',
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Login Logo', 'optix-core' ),
			),
		);
	}
	...
	private function section_register_page(): array {
		return array(
			'join_title'            => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Join Title', 'optix-core' ),
			),
			'join_btn_text'         => array(
				'section'  => 'register_page',
				'type'     => 'string',
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Register Button', 'optix-core' ),
			),
			'join_name_label'       => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Name Label', 'optix-core' ),
			),
			...
			'join_updates_label'    => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Updates Label', 'optix-core' ),
			),
			'join_login_link'       => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Login Link', 'optix-core' ),
			),
			'join_logo'             => array(
				'section'  => 'register_page',
				'type'     => 'string',
			...
			'join_referral_label'   => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Referral Label', 'optix-core' ),
			),
			'join_referral_default' => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Referral Default', 'optix-core' ),
			),
		);
	}
	...
	private function section_portfolio(): array {
		return array(
			'portfolio_title'             => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Portfolio Title', 'optix-core' ),
			),
			'portfolio_projects_per_page' => array(
				...
				'default'  => 9,
				'sanitize' => 'absint',
				'label'    => __( 'Projects Per Page', 'optix-core' ),
			),
			'portfolio_columns'           => array(
				...
				'default'  => 3,
				'sanitize' => 'absint',
				'label'    => __( 'Portfolio Columns', 'optix-core' ),
			),
		);
	}
	...
	private function section_thank_you(): array {
		return array(
			'thank_you_title'    => array(
				...
				'default'  => 'Thank You!',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Thank You Title', 'optix-core' ),
			),
			'thank_you_text'     => array(
				...
				'sanitize' => 'sanitize_textarea_field',
				'label'    => __( 'Thank You Text', 'optix-core' ),
			),
	...
	private function section_load_more(): array {
		return array(
			...
			'load_more_category_text' => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Category Text', 'optix-core' ),
			),
			...
			'load_more_video_vimeo'   => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'Vimeo Embed URL', 'optix-core' ),
			),
			'load_more_video_youtube' => array(
				...
				'default'  => '',
				'sanitize' => 'esc_url_raw',
				'label'    => __( 'YouTube Embed URL', 'optix-core' ),
			),
		);
	}
	...
	private function section_team(): array {
		return array(
			...
			'team_title_inner'     => array(
				...
				'default'  => 'Our Team Members',
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Inner Title', 'optix-core' ),
			),
			'team_heading'         => array(
				'section'  => 'team',
				'type'     => 'string',
	...
	private function section_announcement_bar(): array {
		return array(
			'announcement_bar_enable'     => array(
				...
				'default'  => 0,
				'sanitize' => 'absint',
				'label'    => __( 'Enable Announcement Bar', 'optix-core' ),
			),
			'announcement_bar_text'       => array(
				...
				'sanitize' => 'sanitize_text_field',
				'label'    => __( 'Announcement Text', 'optix-core' ),
			),
