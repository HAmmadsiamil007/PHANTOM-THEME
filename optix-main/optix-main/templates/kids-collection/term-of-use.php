    ...
    <div class="container">
        <div class="col-xl-12 col-lg-12 mr-auto ml-auto">
            <div class="sub-banner-inner-con text-center">
                <h1 class=""><?php echo esc_html( optix_get_option( 'terms_title', 'Term of Use' ) ); ?></h1>
                <div class="breadcrumb-con d-inline-block">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Home', 'optix' ); ?></a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo esc_html( optix_get_option( 'terms_title', 'Term of Use' ) ); ?></li>
                    </ol>
                </div>
            </div>
        </div>
...
<!--TERMS OF SERVICES -->
<section class="privacy-policy-content-con float-left w-100 position-relative padding-top padding-bottom">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <?php echo wp_kses_post( optix_get_option( 'terms_content', '' ) ); ?>
            </div>
        </div>
    </div>
</section>
