<?php
/**
 * Kids Collection - Six Column Full Wide
 *
 * @package optix
 */
	...
	<div class="container">
		<div class="col-xl-12 col-lg-12 mr-auto ml-auto">
			<div class="sub-banner-inner-con text-center">
				<h1 class=""><?php echo esc_html( optix_get_option( 'six_colum_full_wide_title', 'Six Column' ) ); ?></h1>
				<div class="breadcrumb-con d-inline-block">
					<ol class="breadcrumb mb-0">
						<li class="breadcrumb-item"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Home', 'optix' ); ?></a></li>
						<li class="breadcrumb-item active" aria-current="page"><?php echo esc_html( optix_get_option( 'six_colum_full_wide_title', 'Six Column' ) ); ?></li>
					</ol>
				</div>
				<!-- banner inner con -->
			</div>
...
<!-- MAIN SECTION -->
<!--End Slider Section-->
<div class="blog-posts blogpage-section six-main-box float-left w-100">
