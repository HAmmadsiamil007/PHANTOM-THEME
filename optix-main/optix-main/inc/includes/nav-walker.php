  ...
  public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
    ...
    */
    ...
    public static function fallback( $args ) {
      ...
      $fallback_output .= '<li class="menu-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'optix' ) . '">' . esc_html__( 'Add a menu', 'optix' ) . '</a></li>';
      $fallback_output .= '</ul>';
